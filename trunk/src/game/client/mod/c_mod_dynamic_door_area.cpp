...
class C_MOD_Dynamic_Door_Area : public C_ASW_Door_Area
{
	DECLARE_CLASS( C_MOD_Dynamic_Door_Area, C_ASW_Door_Area );
	DECLARE_CLIENTCLASS();
};

IMPLEMENT_CLIENTCLASS_DT( C_MOD_Dynamic_Door_Area, DT_MOD_Dynamic_Door_Area, CMOD_Dynamic_Door_Area )

END_RECV_TABLE()

/*
C_MOD_Dynamic_Door_Area::C_MOD_Dynamic_Door_Area()
{
}

C_ASW_Door* C_MOD_Dynamic_Door_Area::GetASWDoor()
{

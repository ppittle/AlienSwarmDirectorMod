...
CMOD_Build_Map_Frame::~CMOD_Build_Map_Frame()
{
}
...
void CMOD_Build_Map_Frame::UpdateProgress()
{
	if ( !m_pMapBuilder )
		return;
...
/*
void CMOD_Build_Map_Frame::SetEditMapAfterBuild( bool bEditMap, const char *szMapEditFilename )
{
...
void CC_MOD_Build_Map( const CCommand &args )
{
	...
	CMOD_Build_Map_Frame *pFrame = new CMOD_Build_Map_Frame( NULL, "BuildMapFrame", NULL );

#ifndef C_MOD_MARKER_H
#define C_MOD_MARKER_H
#pragma once
...
/*
class C_MOD_Marker : public C_BaseEntity, public IObjectiveMarkerList
{
public:
	DECLARE_CLASS( C_MOD_Marker, C_BaseEntity );
	DECLARE_CLIENTCLASS();
